...
class EmployeeImplTest extends AnyFlatSpec {
  ...
  val wiproEmployee: Employee = Employee("Sunidhi","Sharma",30,40000,"Software Trainee","Wipro","niSunidhi@wipro.com")
  val philipsEmployee: Employee = Employee("Amrita","Kumari",19,50000.00,"Associate software engineer","Philips", "philips123@gmail.com")
  val wipEmployee: Employee = Employee("Nik","Sharma",30,70000,"Software Trainee","Wip","nik@wip")
