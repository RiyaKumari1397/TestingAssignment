...
class EmployeeValidatorIntegrationTest extends AnyFlatSpec {
  ...
  val wiproEmployee: Employee = Employee("Sunidhi", "Sharma", 30,50000.00,"Software Trainee","Wipro","Sunidhi@wipro.com")
  val tcsEmployee: Employee = Employee("Matt", "Donavan", 30,30000.00,"Software Trainee","Tcs","tcstcs")
  val knoldusEmployee: Employee = Employee("Riya", "Kumari", 22,70000.00,"Software Developer","Knoldus","damon@knoldus.com")
